...
export type SingleTripQueryQuery = { __typename?: 'Query', trip: { __typename?: 'TripsEntity', id: number, capacity?: number | null, occupiedSeats?: number | null, plannedAt: any, driverId?: number | null, formattedPickupAddress: string, pickupLatitude: number, pickupLongitude: number, formattedDropoffAddress: string, dropoffLatitude: number, dropoffLongitude: number, passengers?: Array<{ __typename?: 'AppUsersEntity', id: number }> | null } };
